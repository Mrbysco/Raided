...
public class WalkToRaiderGoal extends Goal {
	...
	public WalkToRaiderGoal(Mob mob, double speedModifier, float stopDistance, float areaSize) {
		this.mob = mob;
		this.followPredicate = (livingEntity) -> {
			return livingEntity != null && mob.getClass() != livingEntity.getClass() && AbstractIllager.class == livingEntity.getClass();
		};
