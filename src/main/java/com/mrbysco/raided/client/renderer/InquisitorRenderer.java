...
public class InquisitorRenderer extends MobRenderer<Inquisitor, InquisitorRenderState, InquisitorModel> {
	private static final List<Identifier> TEXTURES = List.of(
			Raided.modLoc("textures/entity/illager/inquisitor01.png"),
			Raided.modLoc("textures/entity/illager/inquisitor02.png"),
			Raided.modLoc("textures/entity/illager/inquisitor03.png"));
	...
	public void extractRenderState(Inquisitor inquisitor, InquisitorRenderState renderState, float partialTick) {
		...
		ArmedEntityRenderState.extractArmedEntityRenderState(inquisitor, renderState, this.itemModelResolver, partialTick);
	...
	@Override
	public Identifier getTextureLocation(InquisitorRenderState renderState) {
